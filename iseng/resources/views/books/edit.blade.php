  ...
  <div class="col-lg-8">
      <form method="post" action="/books/{{ $book->slug }}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            is-invalid
          @enderror" id="code" name="book_code" required autofocus value="{{ old('book_code', $book->book_code) }}">
              @error('book_code')
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('title')
          is-invalid
        @enderror" id="title" name="title" required autofocus value="{{ old('title', $book->title) }}">
            @error('title')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
        ...
        <div class="mb-3">
          ...
          is-invalid
      @enderror" id="slug" name="slug" required value="{{ old('slug' , $book->slug )}}">
          @error('slug')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
        ...
        <div class="mb-3">
          ...
          @else
          <img src="{{ asset('images/cover.jpg') }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
          @endif
